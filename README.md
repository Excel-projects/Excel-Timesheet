...
This Add-In is used to produce a timesheet file with functionality to import your [Google Timeline](https://www.google.com/maps/timeline). I used [Alexandre Attia's blog post](https://medium.com/alex-attia-blog/how-to-take-back-control-and-use-your-google-maps-data-683fb5d4043e) as a reference to write the procedure for downloading the Google Timeline files. 
