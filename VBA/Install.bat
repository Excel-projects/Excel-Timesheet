...
REM	XCOPY ".\Timesheet.xlam" "%AppData%\Microsoft\AddIns\Timesheet.xlam" /E /K /Q /R /Y /D
   	XCOPY ".\Timesheet.xlam" "%AppData%\Microsoft\Excel\XLSTART\Timesheet.xlam" /E /K /Q /R /Y /D
REM	XCOPY ".\Timesheet.xlam" "%AppData%\Roaming\Microsoft\Excel\XLSTART\Timesheet.xlam" /E /K /Q /R /Y /D
